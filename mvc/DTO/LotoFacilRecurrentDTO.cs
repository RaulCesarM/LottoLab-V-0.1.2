...
{
    public class LotoFacilRecurrentDTO
    {
        ...
        public LotoFacilRecurrentDTO()
        {
            
        }
        public LotoFacilRecurrentDTO(int numero, string dataApuracao)
        {
           this.Id = numero;
            this.Concurso = numero;
            this.Data = dataApuracao; 
        }
        public LotoFacilRecurrentDTO(LotoFacilRecurrent entity)
        {
            Id = entity.Id;
