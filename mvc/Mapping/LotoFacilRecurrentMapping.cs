...
{
    public class LotoFacilRecurrentMapping: IEntityTypeConfiguration<LotoFacilRecurrent>
    {
        public void Configure(EntityTypeBuilder<LotoFacilRecurrent> builder)
        {
            builder.ToTable("LotoFacilRecurrent");
