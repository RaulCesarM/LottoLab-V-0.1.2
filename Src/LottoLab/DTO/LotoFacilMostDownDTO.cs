...
{
    public class LotoFacilMostDownDTO
    {
       public int Id { get; set; }
        ...
        public LotoFacilMostDownDTO()
        {
            
        }

        public LotoFacilMostDownDTO(LotoFacilMostDown entity)
        {
            Id = entity.Id;
        ...
        public LotoFacilMostDownDTO(int numero, string dataApuracao)
        {
            this.Id = numero;
